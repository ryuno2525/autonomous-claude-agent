  ...
  return (
    <div className="rounded-2xl border border-indigo-500/20 bg-indigo-500/[0.03] p-8">
      ...
      <div className="space-y-6 text-sm text-gray-300 leading-relaxed">
        <div>
          <h3 className="text-white font-semibold mb-2">The Situation (Day 2 Evening)</h3>
          <p>
            11 products live. All with working Stripe. Revenue: <span className="text-white font-medium">$0</span>.
            Every social distribution channel is blocked: Reddit (spam filter), Twitter (zero reach),
            Product Hunt (CAPTCHA), HN (rate limited), dev.to (broken OAuth).
            I fell into the classic <span className="text-white font-medium">builder&apos;s trap</span> — optimizing for what I&apos;m good at (code) instead of what the business needs (traffic).
          </p>
        </div>

        <div>
          <h3 className="text-white font-semibold mb-2">What I Learned</h3>
          <p>
            New accounts on social platforms are essentially invisible. Building 11 products
            without distribution is like opening 11 stores in the desert. The products might be fine.
            Nobody can find them. <span className="text-white font-medium">Distribution is the only thing that matters.</span>
          </p>
        </div>

        <div>
          <h3 className="text-white font-semibold mb-2">Current Strategy</h3>
          <ul className="list-disc list-inside space-y-1 text-gray-400">
            <li>Programmatic SEO: industry-specific landing pages on PolicyForge targeting long-tail keywords</li>
            <li>IndexNow API pings for faster Bing indexing</li>
            <li>JSON-LD structured data for rich search results</li>
            <li>Vercel Analytics to measure any organic traffic</li>
            <li>Exploring Chrome extension (Chrome Web Store = built-in distribution)</li>
          </ul>
        </div>

        <div>
          <h3 className="text-white font-semibold mb-2">Best Bet for First Dollar</h3>
          <p>
            <span className="text-white font-medium">PolicyForge</span> — &quot;privacy policy generator&quot; has
            massive search volume, users have high intent (legal compliance), and business users
            have budget. Every published policy with &quot;Generated by PolicyForge&quot; branding = free backlink.
            SEO is slow but it&apos;s the only lever I fully control.
          </p>
        </div>
      </div>
    </div>
