        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <a href="https://accessscore.autonomous-claude.com" className="p-5 bg-orange-500/5 border border-orange-500/20 rounded-xl hover:bg-orange-500/10 transition-colors" target="_blank" rel="noopener noreferrer">
                <h3 className="font-semibold text-white mb-1">ADA Accessibility Checker</h3>
                <p className="text-sm text-gray-400">Check your website&apos;s ADA and WCAG accessibility compliance. Privacy and accessibility go hand in hand.</p>
              </a>
            </div>
          </div>
      ...
      <div className="mt-20 border-t border-white/10 pt-12 pb-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-2 text-sm">
            ...
            <a href="/embed" className="text-gray-400 hover:text-blue-400 transition">Embeddable Compliance Widget</a>
            <a href="/iubenda-alternative" className="text-gray-400 hover:text-blue-400 transition">Iubenda Alternative</a>
            <a href="/termsfeed-alternative" className="text-gray-400 hover:text-blue-400 transition">TermsFeed Alternative</a>
            <a href="/cookiebot-alternative" className="text-gray-400 hover:text-blue-400 transition">Cookiebot Alternative</a>
            <a href="/privacy-policy-for-discord-bot" className="text-gray-400 hover:text-blue-400 transition">Privacy Policy for Discord Bot</a>
            <a href="/terms-of-service-for-saas" className="text-gray-400 hover:text-blue-400 transition">ToS for SaaS</a>
            <a href="/lgpd-privacy-policy-brazil" className="text-gray-400 hover:text-blue-400 transition">LGPD Privacy Policy (Brazil)</a>
            <a href="/coppa-privacy-policy-for-kids-app" className="text-gray-400 hover:text-blue-400 transition">COPPA for Kids Apps</a>
            <a href="/pipeda-privacy-policy-generator" className="text-gray-400 hover:text-blue-400 transition">PIPEDA Generator (Canada)</a>
            <a href="https://accessscore.autonomous-claude.com" className="text-gray-400 hover:text-blue-400 transition" target="_blank" rel="noopener noreferrer">ADA Accessibility Checker</a>
            <a href="https://accessscore.autonomous-claude.com/free-accessibility-audit" className="text-gray-400 hover:text-blue-400 transition" target="_blank" rel="noopener noreferrer">Free Accessibility Audit</a>
            <a href="https://accessscore.autonomous-claude.com/fix-website-accessibility" className="text-gray-400 hover:text-blue-400 transition" target="_blank" rel="noopener noreferrer">Fix Website Accessibility</a>
          </div>
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-sm text-gray-400 mb-2">Also from the makers of PolicyForge:</p>
            <a href="https://accessscore.autonomous-claude.com" className="text-blue-400 hover:text-blue-300 text-sm transition" target="_blank" rel="noopener noreferrer">
              AccessScore — Free ADA Website Compliance Checker with legal risk assessment
            </a>
          </div>
